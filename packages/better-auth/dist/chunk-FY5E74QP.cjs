...
var genericOAuth = (options) => {
  ...
  return {
    ...
    endpoints: {
      signInWithOAuth2: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/sign-in/oauth2",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2Callback: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          const result = await chunkDRGY4F3Z_cjs.handleOAuthUserInfo(ctx, {
            userInfo: {
              ...userInfo,
              ...mapUser
            },
