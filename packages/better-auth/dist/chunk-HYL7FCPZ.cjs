...
var phoneNumber = (options) => {
  ...
  return {
    id: "phone-number",
    endpoints: {
      signInPhoneNumber: chunkK3D45DZU_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          if (!session) {
            ...
            throw new betterCall.APIError("UNAUTHORIZED", {
              message: chunkK3D45DZU_cjs.BASE_ERROR_CODES.FAILED_TO_CREATE_SESSION
            });
          }
      ...
      sendPhoneNumberOTP: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      verifyPhoneNumber: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/phone-number/verify",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
            ...
            if (options?.signUpOnVerification) {
              ...
              if (!user) {
                throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
                  message: chunkK3D45DZU_cjs.BASE_ERROR_CODES.FAILED_TO_CREATE_USER
                });
              }
            } else {
          ...
          if (!user) {
            throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
              message: chunkK3D45DZU_cjs.BASE_ERROR_CODES.FAILED_TO_UPDATE_USER
            });
          }
