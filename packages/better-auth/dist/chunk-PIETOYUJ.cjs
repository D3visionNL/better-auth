...
var verifyTwoFactorMiddleware = chunkDRGY4F3Z_cjs.createAuthMiddleware(
  {
    body: zod.z.object({
      /**
...
var backupCode2fa = (options) => {
  ...
  return {
    id: "backup_code",
    endpoints: {
      verifyBackupCode: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      generateBackupCodes: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      viewBackupCodes: chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var otp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const send2FaOTP = chunkDRGY4F3Z_cjs.createAuthEndpoint(
    "/two-factor/send-otp",
    {
      method: "POST",
      use: [verifyTwoFactorMiddleware],
  ...
  const verifyOTP = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var totp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const generateTOTP = chunkDRGY4F3Z_cjs.createAuthEndpoint(
    "/totp/generate",
    {
      method: "POST",
      use: [chunkDRGY4F3Z_cjs.sessionMiddleware],
  ...
  const getTOTPURI = chunkDRGY4F3Z_cjs.createAuthEndpoint(
  ...
  const verifyTOTP = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var twoFactor = (options) => {
  ...
  return {
    ...
    endpoints: {
      ...
      enableTwoFactor: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/two-factor/enable",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!isPasswordValid) {
            throw new betterCall.APIError("BAD_REQUEST", {
              message: chunkDRGY4F3Z_cjs.BASE_ERROR_CODES.INVALID_PASSWORD
            });
          }
      ...
      disableTwoFactor: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/two-factor/disable",
        {
          method: "POST",
          body: zod.z.object({
