...
var multiSession = (options) => {
  ...
  return {
    id: "multi-session",
    endpoints: {
      listDeviceSessions: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      setActiveSession: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      revokeDeviceSession: chunkDUA2LDZ3_cjs.createAuthEndpoint(
