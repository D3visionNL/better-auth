...
var oidcProvider = (options) => {
  ...
  return {
    ...
    endpoints: {
      getOpenIdConfig: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      oAuth2authorize: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2token: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
          body: zod.z.any(),
      ...
      oAuth2userInfo: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
      ...
      registerOAuthApplication: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: zod.z.object({
      ...
      getOAuthClient: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/oauth2/client/:id",
        {
          method: "GET",
          use: [chunkDRGY4F3Z_cjs.sessionMiddleware]
