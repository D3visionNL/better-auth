...
var emailOTP = (options) => {
  ...
  return {
    id: "email-otp",
    endpoints: {
      sendVerificationOTP: chunkVADINYB6_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          const otp = chunkXJGHQ3F6_cjs.generateRandomString(opts.otpLength, "0-9");
      ...
      createVerificationOTP: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      getVerificationOTP: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      verifyEmailOTP: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      signInEmailOTP: chunkVADINYB6_cjs.createAuthEndpoint(
        "/sign-in/email-otp",
        {
          method: "POST",
          body: zod.z.object({
      ...
      forgetPasswordEmailOTP: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      resetPasswordEmailOTP: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      after: [
        {
          ...
          async handler(ctx) {
            ...
            if (response instanceof chunkVADINYB6_cjs.APIError) {
              return;
            }
