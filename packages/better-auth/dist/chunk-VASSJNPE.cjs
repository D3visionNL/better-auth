...
var oidcProvider = (options) => {
  ...
  return {
    ...
    endpoints: {
      getOpenIdConfig: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      oAuth2authorize: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2token: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
          body: zod.z.any(),
      ...
      oAuth2userInfo: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
      ...
      registerOAuthApplication: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: zod.z.object({
      ...
      getOAuthClient: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/oauth2/client/:id",
        {
          method: "GET",
          use: [chunkK3D45DZU_cjs.sessionMiddleware]
