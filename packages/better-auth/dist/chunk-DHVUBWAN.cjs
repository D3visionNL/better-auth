...
var oidcProvider = (options) => {
  ...
  return {
    ...
    endpoints: {
      getOpenIdConfig: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      oAuth2authorize: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2token: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
          body: zod.z.any(),
      ...
      oAuth2userInfo: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
      ...
      registerOAuthApplication: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: zod.z.object({
      ...
      getOAuthClient: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/oauth2/client/:id",
        {
          method: "GET",
          use: [chunkDYWEYR5R_cjs.sessionMiddleware]
