...
var emailOTP = (options) => {
  ...
  return {
    id: "email-otp",
    endpoints: {
      sendVerificationOTP: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      createVerificationOTP: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      getVerificationOTP: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      verifyEmailOTP: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      signInEmailOTP: chunkDRGY4F3Z_cjs.createAuthEndpoint(
        "/sign-in/email-otp",
        {
          method: "POST",
          body: zod.z.object({
      ...
      forgetPasswordEmailOTP: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      resetPasswordEmailOTP: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      after: [
        {
          ...
          async handler(ctx) {
            ...
            if (response instanceof chunkDRGY4F3Z_cjs.APIError) {
              return;
            }
