...
var verifyTwoFactorMiddleware = chunkDYWEYR5R_cjs.createAuthMiddleware(
  {
    body: zod.z.object({
      /**
...
var backupCode2fa = (options) => {
  ...
  return {
    id: "backup_code",
    endpoints: {
      verifyBackupCode: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      generateBackupCodes: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      viewBackupCodes: chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var otp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const send2FaOTP = chunkDYWEYR5R_cjs.createAuthEndpoint(
    "/two-factor/send-otp",
    {
      method: "POST",
      use: [verifyTwoFactorMiddleware],
  ...
  const verifyOTP = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var totp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const generateTOTP = chunkDYWEYR5R_cjs.createAuthEndpoint(
    "/totp/generate",
    {
      method: "POST",
      use: [chunkDYWEYR5R_cjs.sessionMiddleware],
  ...
  const getTOTPURI = chunkDYWEYR5R_cjs.createAuthEndpoint(
  ...
  const verifyTOTP = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var twoFactor = (options) => {
  ...
  return {
    ...
    endpoints: {
      ...
      enableTwoFactor: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/two-factor/enable",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!isPasswordValid) {
            throw new betterCall.APIError("BAD_REQUEST", {
              message: chunkDYWEYR5R_cjs.BASE_ERROR_CODES.INVALID_PASSWORD
            });
          }
      ...
      disableTwoFactor: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/two-factor/disable",
        {
          method: "POST",
          body: zod.z.object({
