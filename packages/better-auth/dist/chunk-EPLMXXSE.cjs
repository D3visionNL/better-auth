...
var genericOAuth = (options) => {
  ...
  return {
    ...
    endpoints: {
      signInWithOAuth2: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/sign-in/oauth2",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2Callback: chunkDYWEYR5R_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          const result = await chunkDYWEYR5R_cjs.handleOAuthUserInfo(ctx, {
            userInfo: {
              ...userInfo,
              ...mapUser
            },
