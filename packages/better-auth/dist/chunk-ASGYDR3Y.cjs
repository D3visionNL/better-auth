...
var oidcProvider = (options) => {
  ...
  return {
    ...
    endpoints: {
      getOpenIdConfig: chunkNKDIPVEC_cjs.createAuthEndpoint(
      ...
      oAuth2authorize: chunkNKDIPVEC_cjs.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: chunkNKDIPVEC_cjs.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2token: chunkNKDIPVEC_cjs.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
          body: zod.z.any(),
      ...
      oAuth2userInfo: chunkNKDIPVEC_cjs.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
      ...
      registerOAuthApplication: chunkNKDIPVEC_cjs.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: zod.z.object({
      ...
      getOAuthClient: chunkNKDIPVEC_cjs.createAuthEndpoint(
        "/oauth2/client/:id",
        {
          method: "GET",
          use: [chunkNKDIPVEC_cjs.sessionMiddleware]
