...
var orgMiddleware = chunkK3D45DZU_cjs.createAuthMiddleware(async (ctx) => {
  return {};
});
var orgSessionMiddleware = chunkK3D45DZU_cjs.createAuthMiddleware(
  {
...
var createInvitation = (option) => chunkK3D45DZU_cjs.createAuthEndpoint(
...
var acceptInvitation = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var rejectInvitation = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var cancelInvitation = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var getInvitation = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var addMember = () => chunkK3D45DZU_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = ctx.body.userId ? await chunkK3D45DZU_cjs.getSessionFromCtx(ctx).catch((e) => null) : null;
    ...
    if (!user) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: chunkK3D45DZU_cjs.BASE_ERROR_CODES.USER_NOT_FOUND
      });
    }
    const alreadyMember = await adapter.findMemberByEmail({
      email: user.email,
...
var removeMember = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var updateMemberRole = (option) => chunkK3D45DZU_cjs.createAuthEndpoint(
...
var getActiveMember = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var createOrganization = chunkK3D45DZU_cjs.createAuthEndpoint(
  "/organization/create",
  {
    method: "POST",
    body: zod.z.object({
...
var updateOrganization = chunkK3D45DZU_cjs.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
var deleteOrganization = chunkK3D45DZU_cjs.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
var getFullOrganization = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var setActiveOrganization = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var listOrganizations = chunkK3D45DZU_cjs.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
var organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await chunkK3D45DZU_cjs.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      ...api,
      hasPermission: chunkK3D45DZU_cjs.createAuthEndpoint(
