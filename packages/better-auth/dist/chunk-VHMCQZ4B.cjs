...
var multiSession = (options) => {
  ...
  return {
    id: "multi-session",
    endpoints: {
      listDeviceSessions: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      setActiveSession: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      revokeDeviceSession: chunkDYWEYR5R_cjs.createAuthEndpoint(
