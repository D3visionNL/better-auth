...
import { S as SocialProviders, b as SocialProviderList, O as OAuthProvider } from './index-D0tmmb_V.cjs';
...
declare const updateUser: <O extends BetterAuthOptions>() => {
    <C extends [better_call.Context<"/update-user", {
        ...
        metadata: {
            $Infer: {
                body: AdditionalUserFieldsInput<O> & {
                    name?: string;
                    image?: string | null;
                };
            };
...
declare function getEndpoints<C extends AuthContext, Option extends BetterAuthOptions>(ctx: Promise<C> | C, options: Option): {
    api: {
        ...
        signUpEmail: {
            <C_1 extends [better_call.Context<"/sign-up/email", {
                method: "POST";
        ...
        updateUser: {
            <C_1 extends [better_call.Context<"/update-user", {
                method: "POST";
                body: zod.ZodRecord<zod.ZodString, zod.ZodAny>;
                use: Endpoint<better_call.Handler<string, better_call.EndpointOptions, {
                    session: {
                ...
                metadata: {
                    $Infer: {
                        body: InferFieldsFromPlugins<Option, "user", "input"> & InferFieldsFromOptions<Option, "user", "input"> & {
                            name?: string;
                            image?: string | null;
                        };
                    };
    ...
    api: InferAPI<{
        ...
        updateUser: {
            <C extends [better_call.Context<"/update-user", {
                ...
                metadata: {
                    $Infer: {
                        body: InferFieldsFromPlugins<O, "user", "input"> & InferFieldsFromOptions<O, "user", "input"> & {
                            name?: string;
                            image?: string | null;
                        };
                    };
