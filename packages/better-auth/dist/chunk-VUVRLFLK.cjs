...
var emailOTP = (options) => {
  ...
  return {
    id: "email-otp",
    endpoints: {
      sendVerificationOTP: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      createVerificationOTP: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      getVerificationOTP: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      verifyEmailOTP: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      signInEmailOTP: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/sign-in/email-otp",
        {
          method: "POST",
          body: zod.z.object({
      ...
      forgetPasswordEmailOTP: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      resetPasswordEmailOTP: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      after: [
        {
          ...
          async handler(ctx) {
            ...
            if (response instanceof chunkK3D45DZU_cjs.APIError) {
              return;
            }
