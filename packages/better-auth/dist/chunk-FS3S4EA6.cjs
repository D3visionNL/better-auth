...
var genericOAuth = (options) => {
  ...
  return {
    ...
    endpoints: {
      signInWithOAuth2: chunkNKDIPVEC_cjs.createAuthEndpoint(
        "/sign-in/oauth2",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2Callback: chunkNKDIPVEC_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          const result = await chunkNKDIPVEC_cjs.handleOAuthUserInfo(ctx, {
            userInfo: {
              ...userInfo,
              ...mapUser
            },
