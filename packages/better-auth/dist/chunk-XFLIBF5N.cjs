...
var admin = (options) => {
  ...
  const adminMiddleware = chunkDYWEYR5R_cjs.createAuthMiddleware(async (ctx) => {
    const session = await chunkDYWEYR5R_cjs.getSessionFromCtx(ctx);
    if (!session?.session) {
      throw new chunkDYWEYR5R_cjs.APIError("UNAUTHORIZED");
    }
    const user = session.user;
    if (!user.role || (Array.isArray(opts.adminRole) ? !opts.adminRole.includes(user.role) : user.role !== opts.adminRole)) {
      throw new chunkDYWEYR5R_cjs.APIError("FORBIDDEN", {
  ...
  return {
    ...
    endpoints: {
      setRole: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/admin/set-role",
        {
          method: "POST",
          body: zod.z.object({
      ...
      createUser: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/admin/create-user",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!user) {
            throw new chunkDYWEYR5R_cjs.APIError("INTERNAL_SERVER_ERROR", {
      ...
      listUsers: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/admin/list-users",
        {
          method: "GET",
          use: [adminMiddleware],
      ...
      listUserSessions: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      unbanUser: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/admin/unban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      banUser: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/admin/ban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      impersonateUser: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      stopImpersonating: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      revokeUserSession: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      revokeUserSessions: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      removeUser: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/admin/remove-user",
        {
          method: "POST",
          body: zod.z.object({
