...
var verifyTwoFactorMiddleware = chunkDUA2LDZ3_cjs.createAuthMiddleware(
  {
    body: zod.z.object({
      /**
...
var backupCode2fa = (options) => {
  ...
  return {
    id: "backup_code",
    endpoints: {
      verifyBackupCode: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      generateBackupCodes: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      viewBackupCodes: chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var otp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const send2FaOTP = chunkDUA2LDZ3_cjs.createAuthEndpoint(
    "/two-factor/send-otp",
    {
      method: "POST",
      use: [verifyTwoFactorMiddleware],
  ...
  const verifyOTP = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var totp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const generateTOTP = chunkDUA2LDZ3_cjs.createAuthEndpoint(
    "/totp/generate",
    {
      method: "POST",
      use: [chunkDUA2LDZ3_cjs.sessionMiddleware],
  ...
  const getTOTPURI = chunkDUA2LDZ3_cjs.createAuthEndpoint(
  ...
  const verifyTOTP = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var twoFactor = (options) => {
  ...
  return {
    ...
    endpoints: {
      ...
      enableTwoFactor: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/two-factor/enable",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!isPasswordValid) {
            throw new betterCall.APIError("BAD_REQUEST", {
              message: chunkDUA2LDZ3_cjs.BASE_ERROR_CODES.INVALID_PASSWORD
            });
          }
      ...
      disableTwoFactor: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/two-factor/disable",
        {
          method: "POST",
          body: zod.z.object({
