...
var verifyTwoFactorMiddleware = chunkK3D45DZU_cjs.createAuthMiddleware(
  {
    body: zod.z.object({
      /**
...
var backupCode2fa = (options) => {
  ...
  return {
    id: "backup_code",
    endpoints: {
      verifyBackupCode: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      generateBackupCodes: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      viewBackupCodes: chunkK3D45DZU_cjs.createAuthEndpoint(
...
var otp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const send2FaOTP = chunkK3D45DZU_cjs.createAuthEndpoint(
    "/two-factor/send-otp",
    {
      method: "POST",
      use: [verifyTwoFactorMiddleware],
  ...
  const verifyOTP = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var totp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const generateTOTP = chunkK3D45DZU_cjs.createAuthEndpoint(
    "/totp/generate",
    {
      method: "POST",
      use: [chunkK3D45DZU_cjs.sessionMiddleware],
  ...
  const getTOTPURI = chunkK3D45DZU_cjs.createAuthEndpoint(
  ...
  const verifyTOTP = chunkK3D45DZU_cjs.createAuthEndpoint(
...
var twoFactor = (options) => {
  ...
  return {
    ...
    endpoints: {
      ...
      enableTwoFactor: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/two-factor/enable",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!isPasswordValid) {
            throw new betterCall.APIError("BAD_REQUEST", {
              message: chunkK3D45DZU_cjs.BASE_ERROR_CODES.INVALID_PASSWORD
            });
          }
      ...
      disableTwoFactor: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/two-factor/disable",
        {
          method: "POST",
          body: zod.z.object({
