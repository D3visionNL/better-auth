...
var emailOTP = (options) => {
  ...
  return {
    id: "email-otp",
    endpoints: {
      sendVerificationOTP: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      createVerificationOTP: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      getVerificationOTP: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      verifyEmailOTP: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      signInEmailOTP: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/sign-in/email-otp",
        {
          method: "POST",
          body: zod.z.object({
      ...
      forgetPasswordEmailOTP: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      resetPasswordEmailOTP: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      after: [
        {
          ...
          async handler(ctx) {
            ...
            if (response instanceof chunkDYWEYR5R_cjs.APIError) {
              return;
            }
