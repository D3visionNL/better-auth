...
import { a as OAuthProvider, S as SocialProviders, b as SocialProviderList, O as OAuth2Tokens } from './better-auth.CggyDr6H.mjs';
...
declare const signInSocial: {
    <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(inputCtx_0: {
        body: {
            provider: (string & {}) | "apple" | "discord" | "facebook" | "github" | "google" | "microsoft" | "spotify" | "twitch" | "twitter" | "dropbox" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "kick" | "zoom";
    ...
    options: {
        ...
        body: z.ZodObject<{
             ...
             */
            provider: z.ZodType<(string & {}) | "apple" | "discord" | "facebook" | "github" | "google" | "microsoft" | "spotify" | "twitch" | "twitter" | "dropbox" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "kick" | "zoom", z.ZodTypeDef, (string & {}) | "apple" | "discord" | "facebook" | "github" | "google" | "microsoft" | "spotify" | "twitch" | "twitter" | "dropbox" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "kick" | "zoom">;
            /**
        ...
        signInSocial: {
            ...
            options: {
                ...
                body: zod.ZodObject<{
                    ...
                    provider: zod.ZodType<(string & {}) | "apple" | "discord" | "facebook" | "github" | "google" | "microsoft" | "spotify" | "twitch" | "twitter" | "dropbox" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "kick" | "zoom", zod.ZodTypeDef, (string & {}) | "apple" | "discord" | "facebook" | "github" | "google" | "microsoft" | "spotify" | "twitch" | "twitter" | "dropbox" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "vk" | "kick" | "zoom">;
...
export { createLogger as $, type AdapterDebugLogs as A, type BetterAuthOptions as B, type CreateCustomAdapter as C, type Account as D, init as E, type AdapterSchemaCreation as F, type GenericEndpointContext as G, type HookEndpointContext as H, type InferOptionSchema as I, type AdapterInstance as J, type KyselyDatabaseType as K, type SecondaryStorage as L, type Models as M, type FilteredAPI as N, type FilterActions as O, type InferSessionAPI as P, type InferAPI as Q, type RateLimit as R, type Session as S, type LogLevel as T, type User as U, type Verification as V, type Where as W, levels as X, shouldPublishLog as Y, type Logger as Z, type LogHandlerParams as _, type Adapter as a, sendVerificationEmail as a$, logger as a0, type FieldAttribute as a1, type FieldType as a2, createInternalAdapter as a3, type InternalAdapter as a4, type FieldAttributeConfig as a5, createFieldAttribute as a6, type InferValueType as a7, type InferFieldsOutput as a8, type InferFieldsInput as a9, deleteSessionCookie as aA, parseCookies as aB, type EligibleCookies as aC, getSessionCookie as aD, getCookieCache as aE, parseSetCookieHeader as aF, setCookieToHeader as aG, getEndpoints as aH, router as aI, signInSocial as aJ, signInEmail as aK, callbackOAuth as aL, getSession as aM, getSessionFromCtx as aN, sessionMiddleware as aO, requestOnlySessionMiddleware as aP, freshSessionMiddleware as aQ, listSessions as aR, revokeSession as aS, revokeSessions as aT, revokeOtherSessions as aU, signOut as aV, forgetPassword as aW, forgetPasswordCallback as aX, resetPassword as aY, createEmailVerificationToken as aZ, sendVerificationEmailFn as a_, type InferFieldsInputClient as aa, type PluginFieldAttribute as ab, type InferFieldsFromPlugins as ac, type InferFieldsFromOptions as ad, type BetterAuthDbSchema as ae, getAuthTables as af, accountSchema as ag, userSchema as ah, sessionSchema as ai, verificationSchema as aj, parseOutputData as ak, getAllFields as al, parseUserOutput as am, parseAccountOutput as an, parseSessionOutput as ao, parseInputData as ap, parseUserInput as aq, parseAdditionalUserInput as ar, parseAccountInput as as, parseSessionInput as at, mergeSchema as au, createCookieGetter as av, getCookies as aw, type BetterAuthCookies as ax, setCookieCache as ay, setSessionCookie as az, type AdapterConfig as b, verifyEmail as b0, updateUser as b1, changePassword as b2, setPassword as b3, deleteUser as b4, deleteUserCallback as b5, changeEmail as b6, error as b7, ok as b8, signUpEmail as b9, listUserAccounts as ba, linkSocialAccount as bb, unlinkAccount as bc, getAccessToken as bd, refreshToken as be, accountInfo as bf, originCheckMiddleware as bg, originCheck as bh, type CustomAdapter as c, type CleanedWhere as d, type AdapterTestDebugLogs as e, BASE_ERROR_CODES as f, type AuthPluginSchema as g, type BetterAuthPlugin as h, type InferPluginErrorCodes as i, createAuthMiddleware as j, createAuthEndpoint as k, type AuthEndpoint as l, type AuthMiddleware as m, type Auth as n, optionsMiddleware as o, type AuthContext as p, type InferUser as q, type InferSession as r, checkPassword as s, type WithJsDoc as t, betterAuth as u, type AdditionalUserFieldsInput as v, type AdditionalUserFieldsOutput as w, type AdditionalSessionFieldsInput as x, type AdditionalSessionFieldsOutput as y, type InferPluginTypes as z };
