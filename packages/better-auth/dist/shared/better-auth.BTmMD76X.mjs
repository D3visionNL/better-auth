...
import { c as createAuthMiddleware, g as getSessionFromCtx, a as createAuthEndpoint, B as BASE_ERROR_CODES } from './better-auth.D_jpufHc.mjs';
import { s as setSessionCookie, d as deleteSessionCookie } from './better-auth.L4mY8Wf-.mjs';
import './better-auth.CiuwFiHM.mjs';
import '@better-auth/core/db';
import { g as getDate } from './better-auth.CW6D9eSx.mjs';
import { m as mergeSchema, p as parseUserOutput } from './better-auth.BZghgUMh.mjs';
                ...
                async before(session, ctx) {
                  ...
                  if (user.banned) {
                    ...
                    if (ctx && (ctx.path.startsWith("/callback") || ctx.path.startsWith("/oauth2/callback"))) {
                      ...
                      throw ctx.redirect(
                        `${redirectURI}?error=banned&error_description=${opts.bannedUserMessage}&error_data=${encodeURIComponent(
                          JSON.stringify({
