...
import { z } from 'zod';
import { c as createAuthMiddleware, s as sessionMiddleware, a as createAuthEndpoint, g as getSessionFromCtx, B as BASE_ERROR_CODES, P as requestOnlySessionMiddleware } from './better-auth.Cle5OGPw.mjs';
