...
var phoneNumber = (options) => {
  ...
  return {
    id: "phone-number",
    endpoints: {
      signInPhoneNumber: chunkDYWEYR5R_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          if (!session) {
            ...
            throw new betterCall.APIError("UNAUTHORIZED", {
              message: chunkDYWEYR5R_cjs.BASE_ERROR_CODES.FAILED_TO_CREATE_SESSION
            });
          }
      ...
      sendPhoneNumberOTP: chunkDYWEYR5R_cjs.createAuthEndpoint(
      ...
      verifyPhoneNumber: chunkDYWEYR5R_cjs.createAuthEndpoint(
        "/phone-number/verify",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
            ...
            if (options?.signUpOnVerification) {
              ...
              if (!user) {
                throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
                  message: chunkDYWEYR5R_cjs.BASE_ERROR_CODES.FAILED_TO_CREATE_USER
                });
              }
            } else {
          ...
          if (!user) {
            throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
              message: chunkDYWEYR5R_cjs.BASE_ERROR_CODES.FAILED_TO_UPDATE_USER
            });
          }
