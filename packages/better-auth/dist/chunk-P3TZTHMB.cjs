...
var orgMiddleware = chunkNKDIPVEC_cjs.createAuthMiddleware(async (ctx) => {
  return {};
});
var orgSessionMiddleware = chunkNKDIPVEC_cjs.createAuthMiddleware(
  {
...
var createInvitation = (option) => chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var acceptInvitation = chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var rejectInvitation = chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var cancelInvitation = chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var getInvitation = chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var addMember = () => chunkNKDIPVEC_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = ctx.body.userId ? await chunkNKDIPVEC_cjs.getSessionFromCtx(ctx).catch((e) => null) : null;
...
var removeMember = chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var updateMemberRole = (option) => chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var getActiveMember = chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var createOrganization = chunkNKDIPVEC_cjs.createAuthEndpoint(
  "/organization/create",
  {
    method: "POST",
    body: zod.z.object({
...
var updateOrganization = chunkNKDIPVEC_cjs.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
var deleteOrganization = chunkNKDIPVEC_cjs.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
var getFullOrganization = chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var setActiveOrganization = chunkNKDIPVEC_cjs.createAuthEndpoint(
...
var listOrganizations = chunkNKDIPVEC_cjs.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
var organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await chunkNKDIPVEC_cjs.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      ...api,
      hasPermission: chunkNKDIPVEC_cjs.createAuthEndpoint(
