...
function generateOTP(size) {
  return chunkXJGHQ3F6_cjs.generateRandomString(size, "0-9");
}
var phoneNumber = (options) => {
  ...
  return {
    id: "phone-number",
    endpoints: {
      signInPhoneNumber: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      sendPhoneNumberOTP: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      verifyPhoneNumber: chunkVADINYB6_cjs.createAuthEndpoint(
        "/phone-number/verify",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
            ...
            if (options?.signUpOnVerification) {
              ...
              if (!user) {
                throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
                  message: chunkVADINYB6_cjs.BASE_ERROR_CODES.FAILED_TO_CREATE_USER
                });
              }
            } else {
          ...
          if (!user) {
            throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
              message: chunkVADINYB6_cjs.BASE_ERROR_CODES.FAILED_TO_UPDATE_USER
            });
          }
