...
var chunkU4I57HJ4_cjs = require('./chunk-U4I57HJ4.cjs');
...
var getOrgAdapter = (context, options) => {
  ...
  return {
    ...
    updateOrganization: async (organizationId, data) => {
      ...
      return {
        ...organization2,
        metadata: organization2.metadata ? chunkU4I57HJ4_cjs.parser_default(organization2.metadata) : void 0
      };
    },
...
var orgMiddleware = chunkDRGY4F3Z_cjs.createAuthMiddleware(async (ctx) => {
  return {};
});
var orgSessionMiddleware = chunkDRGY4F3Z_cjs.createAuthMiddleware(
  {
    use: [chunkDRGY4F3Z_cjs.sessionMiddleware]
  },
  async (ctx) => {
...
var role = zod.z.string();
var invitationStatus = zod.z.enum(["pending", "accepted", "rejected", "canceled"]).default("pending");
zod.z.object({
  id: zod.z.string().default(chunkH74YRRNV_cjs.generateId),
  name: zod.z.string(),
  slug: zod.z.string(),
...
var createInvitation = (option) => chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var acceptInvitation = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var rejectInvitation = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var cancelInvitation = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var getInvitation = chunkDRGY4F3Z_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = await chunkDRGY4F3Z_cjs.getSessionFromCtx(ctx);
    if (!session) {
...
var addMember = () => chunkDRGY4F3Z_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = ctx.body.userId ? await chunkDRGY4F3Z_cjs.getSessionFromCtx(ctx).catch((e) => null) : null;
    ...
    if (!user) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: chunkDRGY4F3Z_cjs.BASE_ERROR_CODES.USER_NOT_FOUND
      });
    }
    const alreadyMember = await adapter.findMemberByEmail({
      email: user.email,
    ...
    const createdMember = await adapter.createMember({
      id: chunkH74YRRNV_cjs.generateId(),
      organizationId: orgId,
      userId: user.id,
      role: ctx.body.role,
      createdAt: /* @__PURE__ */ new Date()
...
var removeMember = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var updateMemberRole = (option) => chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var getActiveMember = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var createOrganization = chunkDRGY4F3Z_cjs.createAuthEndpoint(
  "/organization/create",
  {
    method: "POST",
    body: zod.z.object({
...
var updateOrganization = chunkDRGY4F3Z_cjs.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
var deleteOrganization = chunkDRGY4F3Z_cjs.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
var getFullOrganization = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var setActiveOrganization = chunkDRGY4F3Z_cjs.createAuthEndpoint(
...
var listOrganizations = chunkDRGY4F3Z_cjs.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
var organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await chunkDRGY4F3Z_cjs.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      ...api,
      hasPermission: chunkDRGY4F3Z_cjs.createAuthEndpoint(
