...
var admin = (options) => {
  ...
  const adminMiddleware = chunkDUA2LDZ3_cjs.createAuthMiddleware(async (ctx) => {
    const session = await chunkDUA2LDZ3_cjs.getSessionFromCtx(ctx);
    if (!session?.session) {
      throw new chunkDUA2LDZ3_cjs.APIError("UNAUTHORIZED");
    }
    const user = session.user;
    if (!user.role || (Array.isArray(opts.adminRole) ? !opts.adminRole.includes(user.role) : user.role !== opts.adminRole)) {
      throw new chunkDUA2LDZ3_cjs.APIError("FORBIDDEN", {
  ...
  return {
    ...
    endpoints: {
      setRole: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/admin/set-role",
        {
          method: "POST",
          body: zod.z.object({
      ...
      createUser: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/admin/create-user",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (existUser) {
            throw new chunkDUA2LDZ3_cjs.APIError("BAD_REQUEST", {
          ...
          if (!user) {
            throw new chunkDUA2LDZ3_cjs.APIError("INTERNAL_SERVER_ERROR", {
      ...
      listUsers: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/admin/list-users",
        {
          method: "GET",
          use: [adminMiddleware],
      ...
      listUserSessions: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      unbanUser: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/admin/unban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      banUser: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/admin/ban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      impersonateUser: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          if (!targetUser) {
            throw new chunkDUA2LDZ3_cjs.APIError("NOT_FOUND", {
      ...
      stopImpersonating: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      revokeUserSession: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      revokeUserSessions: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      removeUser: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/admin/remove-user",
        {
          method: "POST",
          body: zod.z.object({
