...
var multiSession = (options) => {
  ...
  return {
    id: "multi-session",
    endpoints: {
      listDeviceSessions: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      setActiveSession: chunkDRGY4F3Z_cjs.createAuthEndpoint(
      ...
      revokeDeviceSession: chunkDRGY4F3Z_cjs.createAuthEndpoint(
