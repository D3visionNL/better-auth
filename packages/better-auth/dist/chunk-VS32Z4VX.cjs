...
var emailOTP = (options) => {
  ...
  return {
    id: "email-otp",
    endpoints: {
      sendVerificationOTP: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      createVerificationOTP: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      getVerificationOTP: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      verifyEmailOTP: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      signInEmailOTP: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/sign-in/email-otp",
        {
          method: "POST",
          body: zod.z.object({
      ...
      forgetPasswordEmailOTP: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      resetPasswordEmailOTP: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      after: [
        {
          ...
          async handler(ctx) {
            ...
            if (response instanceof chunkDUA2LDZ3_cjs.APIError) {
              return;
            }
