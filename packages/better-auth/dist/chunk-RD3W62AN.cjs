...
var multiSession = (options) => {
  ...
  return {
    id: "multi-session",
    endpoints: {
      listDeviceSessions: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      setActiveSession: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      revokeDeviceSession: chunkVADINYB6_cjs.createAuthEndpoint(
