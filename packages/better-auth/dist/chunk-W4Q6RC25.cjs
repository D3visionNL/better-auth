...
var orgMiddleware = chunkDUA2LDZ3_cjs.createAuthMiddleware(async (ctx) => {
  return {};
});
var orgSessionMiddleware = chunkDUA2LDZ3_cjs.createAuthMiddleware(
  {
    use: [chunkDUA2LDZ3_cjs.sessionMiddleware]
  },
  async (ctx) => {
...
var createInvitation = (option) => chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var acceptInvitation = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var rejectInvitation = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var cancelInvitation = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var getInvitation = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var addMember = () => chunkDUA2LDZ3_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = ctx.body.userId ? await chunkDUA2LDZ3_cjs.getSessionFromCtx(ctx).catch((e) => null) : null;
    ...
    if (!user) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: chunkDUA2LDZ3_cjs.BASE_ERROR_CODES.USER_NOT_FOUND
      });
    }
    const alreadyMember = await adapter.findMemberByEmail({
      email: user.email,
...
var removeMember = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var updateMemberRole = (option) => chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var getActiveMember = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var createOrganization = chunkDUA2LDZ3_cjs.createAuthEndpoint(
  "/organization/create",
  {
    method: "POST",
    body: zod.z.object({
...
var updateOrganization = chunkDUA2LDZ3_cjs.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
var deleteOrganization = chunkDUA2LDZ3_cjs.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
var getFullOrganization = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var setActiveOrganization = chunkDUA2LDZ3_cjs.createAuthEndpoint(
...
var listOrganizations = chunkDUA2LDZ3_cjs.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
var organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await chunkDUA2LDZ3_cjs.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      ...api,
      hasPermission: chunkDUA2LDZ3_cjs.createAuthEndpoint(
