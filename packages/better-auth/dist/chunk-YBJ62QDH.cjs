...
var admin = (options) => {
  ...
  const adminMiddleware = chunkVADINYB6_cjs.createAuthMiddleware(async (ctx) => {
    ...
    if (!user.role || (Array.isArray(opts.adminRole) ? !opts.adminRole.includes(user.role) : user.role !== opts.adminRole)) {
      throw new chunkVADINYB6_cjs.APIError("FORBIDDEN", {
  ...
  return {
    ...
    endpoints: {
      setRole: chunkVADINYB6_cjs.createAuthEndpoint(
        "/admin/set-role",
        {
          method: "POST",
          body: zod.z.object({
      ...
      createUser: chunkVADINYB6_cjs.createAuthEndpoint(
        "/admin/create-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      listUsers: chunkVADINYB6_cjs.createAuthEndpoint(
        "/admin/list-users",
        {
          method: "GET",
          use: [adminMiddleware],
      ...
      listUserSessions: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      unbanUser: chunkVADINYB6_cjs.createAuthEndpoint(
        "/admin/unban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      banUser: chunkVADINYB6_cjs.createAuthEndpoint(
        "/admin/ban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      impersonateUser: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      stopImpersonating: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      revokeUserSession: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      revokeUserSessions: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      removeUser: chunkVADINYB6_cjs.createAuthEndpoint(
        "/admin/remove-user",
        {
          method: "POST",
          body: zod.z.object({
    ...
    schema: chunkWRPAFI4I_cjs.mergeSchema(schema, opts.schema)
  };
};
var schema = {
  user: {
