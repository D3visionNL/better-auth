...
var genericOAuth = (options) => {
  ...
  return {
    ...
    endpoints: {
      signInWithOAuth2: chunkK3D45DZU_cjs.createAuthEndpoint(
        "/sign-in/oauth2",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2Callback: chunkK3D45DZU_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          const result = await chunkK3D45DZU_cjs.handleOAuthUserInfo(ctx, {
            userInfo: {
              ...userInfo,
              ...mapUser
            },
