...
var multiSession = (options) => {
  ...
  return {
    id: "multi-session",
    endpoints: {
      listDeviceSessions: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      setActiveSession: chunkK3D45DZU_cjs.createAuthEndpoint(
      ...
      revokeDeviceSession: chunkK3D45DZU_cjs.createAuthEndpoint(
