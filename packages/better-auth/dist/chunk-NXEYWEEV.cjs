...
var magicLink = (options) => {
  return {
    id: "magic-link",
    endpoints: {
      signInMagicLink: chunkVADINYB6_cjs.createAuthEndpoint(
        "/sign-in/magic-link",
        {
          method: "POST",
          requireHeaders: true,
        ...
        async (ctx) => {
          ...
          const verificationToken = chunkXJGHQ3F6_cjs.generateRandomString(32, "a-z", "A-Z");
      ...
      magicLinkVerify: chunkVADINYB6_cjs.createAuthEndpoint(
        "/magic-link/verify",
        {
          method: "GET",
          query: zod.z.object({
