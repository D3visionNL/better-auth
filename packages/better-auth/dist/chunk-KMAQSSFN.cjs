...
var oidcProvider = (options) => {
  ...
  return {
    ...
    endpoints: {
      getOpenIdConfig: chunkDUA2LDZ3_cjs.createAuthEndpoint(
      ...
      oAuth2authorize: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2token: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
          body: zod.z.any(),
      ...
      oAuth2userInfo: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
      ...
      registerOAuthApplication: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: zod.z.object({
      ...
      getOAuthClient: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/oauth2/client/:id",
        {
          method: "GET",
          use: [chunkDUA2LDZ3_cjs.sessionMiddleware]
