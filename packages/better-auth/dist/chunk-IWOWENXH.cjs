...
var orgMiddleware = chunkVADINYB6_cjs.createAuthMiddleware(async (ctx) => {
  return {};
});
var orgSessionMiddleware = chunkVADINYB6_cjs.createAuthMiddleware(
  {
...
var createInvitation = (option) => chunkVADINYB6_cjs.createAuthEndpoint(
...
var acceptInvitation = chunkVADINYB6_cjs.createAuthEndpoint(
...
var rejectInvitation = chunkVADINYB6_cjs.createAuthEndpoint(
...
var cancelInvitation = chunkVADINYB6_cjs.createAuthEndpoint(
...
var getInvitation = chunkVADINYB6_cjs.createAuthEndpoint(
...
var addMember = () => chunkVADINYB6_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = ctx.body.userId ? await chunkVADINYB6_cjs.getSessionFromCtx(ctx).catch((e) => null) : null;
    ...
    if (!user) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: chunkVADINYB6_cjs.BASE_ERROR_CODES.USER_NOT_FOUND
      });
    }
    const alreadyMember = await adapter.findMemberByEmail({
      email: user.email,
...
var removeMember = chunkVADINYB6_cjs.createAuthEndpoint(
...
var updateMemberRole = (option) => chunkVADINYB6_cjs.createAuthEndpoint(
...
var getActiveMember = chunkVADINYB6_cjs.createAuthEndpoint(
...
var createOrganization = chunkVADINYB6_cjs.createAuthEndpoint(
  "/organization/create",
  {
    method: "POST",
    body: zod.z.object({
...
var updateOrganization = chunkVADINYB6_cjs.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
var deleteOrganization = chunkVADINYB6_cjs.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
var getFullOrganization = chunkVADINYB6_cjs.createAuthEndpoint(
...
var setActiveOrganization = chunkVADINYB6_cjs.createAuthEndpoint(
...
var listOrganizations = chunkVADINYB6_cjs.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
var organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await chunkVADINYB6_cjs.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      ...api,
      hasPermission: chunkVADINYB6_cjs.createAuthEndpoint(
