...
async function authorize(ctx, options) {
  ...
  const code = chunkXJGHQ3F6_cjs.generateRandomString(32, "a-z", "A-Z", "0-9");
...
var oidcProvider = (options) => {
  ...
  return {
      ...
      after: [
        {
          ...
          handler: async (ctx) => {
            ...
            const parsedSetCookieHeader = chunkOJX3P352_cjs.parseSetCookieHeader(
    ...
    endpoints: {
      getOpenIdConfig: chunkVADINYB6_cjs.createAuthEndpoint(
      ...
      oAuth2authorize: chunkVADINYB6_cjs.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: chunkVADINYB6_cjs.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!storedCode) {
            throw new chunkVADINYB6_cjs.APIError("UNAUTHORIZED", {
      ...
      oAuth2token: chunkVADINYB6_cjs.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
          body: zod.z.any(),
        ...
        async (ctx) => {
          ...
          if (grant_type === "refresh_token") {
            ...
            const accessToken2 = chunkXJGHQ3F6_cjs.generateRandomString(32, "a-z", "A-Z");
            const newRefreshToken = chunkXJGHQ3F6_cjs.generateRandomString(32, "a-z", "A-Z");
          ...
          const accessToken = chunkXJGHQ3F6_cjs.generateRandomString(32, "a-z", "A-Z");
          const refreshToken = chunkXJGHQ3F6_cjs.generateRandomString(32, "A-Z", "a-z");
      ...
      oAuth2userInfo: chunkVADINYB6_cjs.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
      ...
      registerOAuthApplication: chunkVADINYB6_cjs.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          const clientId = options.generateClientId?.() || chunkXJGHQ3F6_cjs.generateRandomString(32, "a-z", "A-Z");
          const clientSecret = options.generateClientSecret?.() || chunkXJGHQ3F6_cjs.generateRandomString(32, "a-z", "A-Z");
      ...
      getOAuthClient: chunkVADINYB6_cjs.createAuthEndpoint(
        "/oauth2/client/:id",
        {
          method: "GET",
          use: [chunkVADINYB6_cjs.sessionMiddleware]
