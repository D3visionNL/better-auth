...
var genericOAuth = (options) => {
  ...
  return {
    ...
    endpoints: {
      signInWithOAuth2: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        "/sign-in/oauth2",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          const { state, codeVerifier } = await chunk5E75URIA_cjs.generateState(ctx);
          const authUrl = await chunk2D7VGWTP_cjs.createAuthorizationURL({
            id: providerId,
            options: {
              clientId,
              clientSecret,
      ...
      oAuth2Callback: chunkDUA2LDZ3_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          try {
            ...
            tokens = await chunk2D7VGWTP_cjs.validateAuthorizationCode({
              code,
          ...
          const result = await chunkDUA2LDZ3_cjs.handleOAuthUserInfo(ctx, {
            userInfo: {
              ...userInfo,
              ...mapUser
            },
