...
var orgMiddleware = chunkDYWEYR5R_cjs.createAuthMiddleware(async (ctx) => {
  return {};
});
var orgSessionMiddleware = chunkDYWEYR5R_cjs.createAuthMiddleware(
  {
...
var createInvitation = (option) => chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var acceptInvitation = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var rejectInvitation = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var cancelInvitation = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var getInvitation = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var addMember = () => chunkDYWEYR5R_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = ctx.body.userId ? await chunkDYWEYR5R_cjs.getSessionFromCtx(ctx).catch((e) => null) : null;
    ...
    if (!user) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: chunkDYWEYR5R_cjs.BASE_ERROR_CODES.USER_NOT_FOUND
      });
    }
    const alreadyMember = await adapter.findMemberByEmail({
      email: user.email,
...
var removeMember = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var updateMemberRole = (option) => chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var getActiveMember = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var createOrganization = chunkDYWEYR5R_cjs.createAuthEndpoint(
  "/organization/create",
  {
    method: "POST",
    body: zod.z.object({
...
var updateOrganization = chunkDYWEYR5R_cjs.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
var deleteOrganization = chunkDYWEYR5R_cjs.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
var getFullOrganization = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var setActiveOrganization = chunkDYWEYR5R_cjs.createAuthEndpoint(
...
var listOrganizations = chunkDYWEYR5R_cjs.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
var organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await chunkDYWEYR5R_cjs.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      ...api,
      hasPermission: chunkDYWEYR5R_cjs.createAuthEndpoint(
